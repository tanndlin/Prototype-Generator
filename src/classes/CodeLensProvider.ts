...
export class MyCodeLensProvider implements vscode.CodeLensProvider {
  ...
  private _getPrototypes(document: vscode.TextDocument, mainLine: number): number[] {
    const lines = [];
  ...
  private _getMethodLength(document: vscode.TextDocument, lineNum: number): number {
  ...
  private _getMethodRefCount(document: vscode.TextDocument, lineNum: number): number {
